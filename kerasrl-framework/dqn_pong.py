...
if args.mode == 'train':
    ...
    weights_filename = f'checkpoints/pong/dqn_{args.env_name}_weights.h5f'
    checkpoint_weights_filename = 'checkpoints/pong/dqn_' + \
        args.env_name + '_weights_{step}.h5f'
    log_filename = f'checkpoints/pong/dqn_{args.env_name}_log.json'
